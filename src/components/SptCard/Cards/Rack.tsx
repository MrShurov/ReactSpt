...
import {Button, Col, CustomInput, FormGroup, Input, Modal, ModalBody, ModalFooter, ModalHeader} from 'reactstrap';

@observer
export default class Rack extends React.Component <{ sptStore: ISptStore, calculationUrl: string, goodName: string }
    , { modal: boolean, perforation: string }> {
